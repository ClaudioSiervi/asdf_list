...
import family_list_project.managers.users
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', models.DateField(blank=True, null=True, verbose_name='Birthday date')),
            ...
            managers=[
                ('objects', family_list_project.managers.users.UserManager()),
            ],
        ),
    ]
